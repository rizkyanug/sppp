              ...
              <div class="card card-statistic-2">
                <div class="card-stats">
                  <div class="card-stats-title">DATA KELAS -
                    ...
                    <a data-toggle="dropdown" href="#" id="orders-month">XII OTKP 1</a>
                    </div>
                  </div>
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card card-statistic-2">
                <div class="card-stats">
                  <div class="card-stats-title">DATA KELAS -
                    <div class="dropdown d-inline">
                      <a data-toggle="dropdown" href="#" id="orders-month">XII OTKP 2</a>
                    </div>
                  </div>
                  <div class="card-stats-items">
                    <div class="card-stats-item">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card card-statistic-2">
                <div class="card-stats">
                  <div class="card-stats-title">DATA KELAS -
                    <div class="dropdown d-inline">
                      <a data-toggle="dropdown" href="#" id="orders-month">XII AKL</a>
                    </div>
                  </div>
                  <div class="card-stats-items">
                    <div class="card-stats-item">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card card-statistic-2">
                <div class="card-stats">
                  <div class="card-stats-title">DATA KELAS -
                    <div class="dropdown d-inline">
                      <a data-toggle="dropdown" href="#" id="orders-month">XII BDP</a>
                    </div>
                  </div>
                  <div class="card-stats-items">
                    <div class="card-stats-item">
            ...
            <div class="col-lg-4 col-md-4 col-sm-12">
              <div class="card card-statistic-2">
                <div class="card-stats">
                  <div class="card-stats-title">DATA KELAS -
                    <div class="dropdown d-inline">
                      <a data-toggle="dropdown" href="#" id="orders-month">XII RPL</a>
                    </div>
                  </div>
                  <div class="card-stats-items">
                    <div class="card-stats-item">
